...
let cart=safeJSON("diamondEmpireCart",[]);
let activeFilter="All";
let wishes=safeJSON("diamondEmpireWishes",[]);
...
if("IntersectionObserver" in window){
  ...
  revealItems.forEach((el,i)=>{el.style.transitionDelay=`${Math.min(i*45,180)}ms`;revealObserver.observe(el)});
